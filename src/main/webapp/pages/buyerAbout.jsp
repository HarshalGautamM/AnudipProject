            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>Welcome to Imperial Realty, Mumbai a luxury urban residence designed for maximum value for price and space.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Imperial Realty, Mumbai 
						from the house of Real Estate, presenting in Mumbai for sale.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>At Imperial Realty, Mumbai life extends beyond the expectation to embrace your life.
						Built with meticulousness and inimitable features, Imperial Realty, Mumbai is just for the chosen few.</p>
						     <p><i class="fa fa-check text-primary me-3"></i>This project is close to some of Mumbai's biggest Industrial landmarks, like SP Infocity, Magarpatta IT Park, and EON IT Park.
						Discover a quality of life at Imperial Realty, Mumbai that is truly unique.</p>
